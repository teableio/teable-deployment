...
`ghcr.io/teableio/teable:latest` now resolves to `release.2026-09-25T09-38-50Z.3268`.
...
### Teable release.2026-09-25T04-01-19Z.3254

`ghcr.io/teableio/teable:latest` now resolves to `release.2026-09-25T04-01-19Z.3254`.

## v2026.9.30 - 2026-09-22

### Teable release.2026-09-22T03-34-15Z.3202

`ghcr.io/teableio/teable:latest` now resolves to `release.2026-09-22T03-34-15Z.3202`.

## v2026.9.29 - 2026-09-22
...
`ghcr.io/teableio/teable:latest` now resolves to `release.2026-09-21T07-48-52Z.3187`.

## v2026.9.27 - 2026-09-21
...
### Teable release.2026-09-17T13-29-16Z.3151

#### Feature Updates

- App Builder now notifies users when a version cannot be saved because the artifact is too large, provides cleanup guidance, and allows users to send failure details to AI for help.
- Routine runs can now continue until they complete, fail, or are manually stopped, without being subject to a fixed maximum duration. Run history also displays the start and end times.
- The new chat launch card on mobile can now use project-specific recommendations more reliably and loads them in the background to reduce wait times.

#### Bug Fixes & Improvements

- The mobile home page and project chat history no longer display conversations from apps that have been moved to the recycle bin or permanently deleted. Conversations generated by apps remain hidden while the app is deleted and reappear after the app is restored.
- Fixed Composio connection handling issues on web and mobile, including Gmail and API key-based tools, ensuring that users enter the correct connection flow and that canceled connections do not reuse unrelated accounts.
- Fixed an issue where connected Composio apps could not be used by Agents.

[Full release notes](https://github.com/teableio/teable/releases/tag/release.2026-09-17T13-29-16Z.3151)
...
`ghcr.io/teableio/teable:latest` now resolves to `release.2026-09-10T00-17-07Z.3010`.

## v2026.9.20 - 2026-09-09

### Teable release.2026-09-09T10-26-44Z.3004

`ghcr.io/teableio/teable:latest` now resolves to `release.2026-09-09T10-26-44Z.3004`.

## v2026.9.19 - 2026-09-09
...
`ghcr.io/teableio/teable:latest` now resolves to `release.2026-09-08T01-36-21Z.2976`.

[Full release notes](https://github.com/teableio/teable/releases/tag/release.2026-09-08T01-36-21Z.2976)

## v2026.9.13 - 2026-09-08
...
`ghcr.io/teableio/teable:latest` now resolves to `release.2026-09-07T03-18-00Z.2953`.

## v2026.9.9 - 2026-09-07

### Teable release.2026-09-07T01-58-27Z.2952

`ghcr.io/teableio/teable:latest` now resolves to `release.2026-09-07T01-58-27Z.2952`.

## v2026.9.8 - 2026-09-06
...
#### Bug Fixes & Improvements
- Improved error handling for collaboration and shared document loading, returning clearer permission-related errors when activity replay fails.

[Full release notes](https://github.com/teableio/teable/releases/tag/release.2026-09-05T15-06-03Z.2943)

## v2026.9.6 - 2026-09-05
...
`ghcr.io/teableio/teable:latest` now resolves to `release.2026-09-04T10-30-33Z.2931`.

## v2026.9.3 - 2026-09-04

### Teable release.2026-09-04T09-00-16Z.2928

`ghcr.io/teableio/teable:latest` now resolves to `release.2026-09-04T09-00-16Z.2928`.

## v2026.9.2 - 2026-09-03
...
`ghcr.io/teableio/teable:latest` now resolves to `release.2026-09-02T03-16-51Z.2899`.

## v2026.8.53 - 2026-08-31
