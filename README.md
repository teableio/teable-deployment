...
| Domain & DNS | local: none (`*.localhost`) · server: one domain with four records (public DNS or your internal DNS; [intranet guide](docker/all-in-one/private-network.md)) | one managed domain with DNS control |
