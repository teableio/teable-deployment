...
> Generated for platform release **v2026.9.32** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-25T09-38-50Z.3268` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-25T09-38-50Z.3268` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-25T09-38-50Z.3268 \
    ...
    caddy:2.9.1 \
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-25T09-38-50Z.3268; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-25T09-38-50Z.3268` (asserted available on both registries at release time).
