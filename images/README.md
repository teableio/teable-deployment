...
> Generated for platform release **v2026.9.2** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-03T13-21-49Z.2922` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-03T13-21-49Z.2922` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-03T13-21-49Z.2922 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-03T13-21-49Z.2922; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-03T13-21-49Z.2922` (asserted available on both registries at release time).
