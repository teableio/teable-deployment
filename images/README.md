...
> Generated for platform release **v2026.9.24** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-17T08-29-35Z.3144` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-17T08-29-35Z.3144` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-17T08-29-35Z.3144 \
    ...
    caddy:2.9.1 \
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-17T08-29-35Z.3144; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-17T08-29-35Z.3144` (asserted available on both registries at release time).
