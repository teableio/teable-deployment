...
> Generated for platform release **v2026.9.25** -- do not edit by hand.
...
Every `ghcr.io/teableio/` image is mirrored with **identical tags** (this
includes MinIO, which we host there since upstream withdrew its Docker Hub
images; the digests match the upstream builds):

| Canonical (ghcr.io) | Mirror (Aliyun Shenzhen) |
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-18T12-29-19Z.3168` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-18T12-29-19Z.3168` |
...
| `ghcr.io/teableio/teable-infra-service:20260917T085728Z` | `registry.cn-shenzhen.aliyuncs.com/teable/teable-infra-service:20260917T085728Z` |
...
| `ghcr.io/teableio/minio:RELEASE.2025-04-22T22-12-26Z` | `registry.cn-shenzhen.aliyuncs.com/teable/minio:RELEASE.2025-04-22T22-12-26Z` |
| `ghcr.io/teableio/minio-mc:RELEASE.2025-04-16T18-13-26Z` | `registry.cn-shenzhen.aliyuncs.com/teable/minio-mc:RELEASE.2025-04-16T18-13-26Z` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-18T12-29-19Z.3168 \
    ghcr.io/teableio/teable-app-runtime:20260717T042653Z \
    ghcr.io/teableio/teable-infra-service:20260917T085728Z \
    ...
    postgres:15.4 \
    redis:7.2.4 \
    ghcr.io/teableio/minio:RELEASE.2025-04-22T22-12-26Z \
    ghcr.io/teableio/minio-mc:RELEASE.2025-04-16T18-13-26Z \
    caddy:2.9.1 \
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-18T12-29-19Z.3168; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-18T12-29-19Z.3168` (asserted available on both registries at release time).
