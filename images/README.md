...
> Generated for platform release **v2026.9.31** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-25T04-01-19Z.3254` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-25T04-01-19Z.3254` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-25T04-01-19Z.3254 \
    ...
    caddy:2.9.1 \
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-25T04-01-19Z.3254; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-25T04-01-19Z.3254` (asserted available on both registries at release time).
