...
> Generated for platform release **v2026.9.23** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-11T07-36-49Z.3059` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-11T07-36-49Z.3059` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-11T07-36-49Z.3059 \
    ...
    caddy:2.9.1 \
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-11T07-36-49Z.3059; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-11T07-36-49Z.3059` (asserted available on both registries at release time).
