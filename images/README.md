...
> Generated for platform release **v2026.7.13** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-07-23T12-32-52Z.2361` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-07-23T12-32-52Z.2361` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-07-23T12-32-52Z.2361 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-07-23T12-32-52Z.2361; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-07-23T12-32-52Z.2361` (asserted available on both registries at release time).
