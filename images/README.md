...
> Generated for platform release **v2026.9.1** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-02T10-18-27Z.2908` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-02T10-18-27Z.2908` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-02T10-18-27Z.2908 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-02T10-18-27Z.2908; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-02T10-18-27Z.2908` (asserted available on both registries at release time).
