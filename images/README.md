...
> Generated for platform release **v2026.9.8** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-06T12-49-30Z.2949` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-06T12-49-30Z.2949` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-06T12-49-30Z.2949 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-06T12-49-30Z.2949; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-06T12-49-30Z.2949` (asserted available on both registries at release time).
