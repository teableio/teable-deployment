...
> Generated for platform release **v2026.9.20** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-09T10-26-44Z.3004` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-09T10-26-44Z.3004` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-09T10-26-44Z.3004 \
    ...
    caddy:2.9.1 \
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-09T10-26-44Z.3004; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-09T10-26-44Z.3004` (asserted available on both registries at release time).
