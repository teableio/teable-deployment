...
> Generated for platform release **v2026.8.51** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-08-28T05-16-40Z.2847` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-08-28T05-16-40Z.2847` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-08-28T05-16-40Z.2847 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-08-28T05-16-40Z.2847; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-08-28T05-16-40Z.2847` (asserted available on both registries at release time).
