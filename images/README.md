...
> Generated for platform release **v2026.9.4** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-04T10-30-33Z.2931` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-04T10-30-33Z.2931` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-04T10-30-33Z.2931 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-04T10-30-33Z.2931; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-04T10-30-33Z.2931` (asserted available on both registries at release time).
