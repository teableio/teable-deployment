...
> Generated for platform release **v2026.7.11** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-07-21T00-26-02Z.2300` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-07-21T00-26-02Z.2300` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-07-21T00-26-02Z.2300 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-07-21T00-26-02Z.2300; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-07-21T00-26-02Z.2300` (asserted available on both registries at release time).
