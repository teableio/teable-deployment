...
> Generated for platform release **v2026.9.26** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-19T11-56-47Z.3177` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-19T11-56-47Z.3177` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-19T11-56-47Z.3177 \
    ...
    caddy:2.9.1 \
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-19T11-56-47Z.3177; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-19T11-56-47Z.3177` (asserted available on both registries at release time).
