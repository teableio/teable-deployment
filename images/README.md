...
> Generated for platform release **v2026.7.10** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-07-18T09-45-26Z.2275` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-07-18T09-45-26Z.2275` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-07-18T09-45-26Z.2275 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-07-18T09-45-26Z.2275; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-07-18T09-45-26Z.2275` (asserted available on both registries at release time).
