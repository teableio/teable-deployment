...
> Generated for platform release **v2026.9.27** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-20T13-36-35Z.3184` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-20T13-36-35Z.3184` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-20T13-36-35Z.3184 \
    ...
    caddy:2.9.1 \
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-20T13-36-35Z.3184; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-20T13-36-35Z.3184` (asserted available on both registries at release time).
