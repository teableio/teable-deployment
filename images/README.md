...
> Generated for platform release **v2026.7.6** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-07-17T05-20-38Z.2264` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-07-17T05-20-38Z.2264` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-07-17T05-20-38Z.2264 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-07-17T05-20-38Z.2264; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-07-17T05-20-38Z.2264` (asserted available on both registries at release time).
