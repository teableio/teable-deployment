...
> Generated for platform release **v2026.9.9** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-07T01-58-27Z.2952` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-07T01-58-27Z.2952` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-07T01-58-27Z.2952 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-07T01-58-27Z.2952; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-07T01-58-27Z.2952` (asserted available on both registries at release time).
