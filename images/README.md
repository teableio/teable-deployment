...
> Generated for platform release **v2026.9.6** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-05T12-11-06Z.2942` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-05T12-11-06Z.2942` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-05T12-11-06Z.2942 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-05T12-11-06Z.2942; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-05T12-11-06Z.2942` (asserted available on both registries at release time).
