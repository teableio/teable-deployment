...
> Generated for platform release **v2026.9.3** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-04T09-00-16Z.2928` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-04T09-00-16Z.2928` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-04T09-00-16Z.2928 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-04T09-00-16Z.2928; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-04T09-00-16Z.2928` (asserted available on both registries at release time).
