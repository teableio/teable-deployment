...
> Generated for platform release **v2026.9.5** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-05T08-43-19Z.2938` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-05T08-43-19Z.2938` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-05T08-43-19Z.2938 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-05T08-43-19Z.2938; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-05T08-43-19Z.2938` (asserted available on both registries at release time).
