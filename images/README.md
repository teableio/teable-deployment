...
> Generated for platform release **v2026.9.11** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-07T06-05-47Z.2955` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-07T06-05-47Z.2955` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-07T06-05-47Z.2955 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-07T06-05-47Z.2955; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-07T06-05-47Z.2955` (asserted available on both registries at release time).
