...
> Generated for platform release **v2026.9.10** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-07T03-18-00Z.2953` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-07T03-18-00Z.2953` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-07T03-18-00Z.2953 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-07T03-18-00Z.2953; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-07T03-18-00Z.2953` (asserted available on both registries at release time).
