...
> Generated for platform release **v2026.9.0** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-02T03-16-51Z.2899` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-02T03-16-51Z.2899` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-02T03-16-51Z.2899 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-02T03-16-51Z.2899; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-02T03-16-51Z.2899` (asserted available on both registries at release time).
