...
> Generated for platform release **v2026.9.7** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-05T15-06-03Z.2943` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-05T15-06-03Z.2943` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-05T15-06-03Z.2943 \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-05T15-06-03Z.2943; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-05T15-06-03Z.2943` (asserted available on both registries at release time).
