...
> Generated for platform release **v2026.9.28** -- do not edit by hand.
...
|---|---|
| `ghcr.io/teableio/teable:release.2026-09-21T07-48-52Z.3187` | `registry.cn-shenzhen.aliyuncs.com/teable/teable:release.2026-09-21T07-48-52Z.3187` |
...
for img in \
    ghcr.io/teableio/teable:release.2026-09-21T07-48-52Z.3187 \
    ...
    caddy:2.9.1 \
    ghcr.io/teableio/teable-sandbox-agent:release.2026-09-21T07-48-52Z.3187; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-09-21T07-48-52Z.3187` (asserted available on both registries at release time).
